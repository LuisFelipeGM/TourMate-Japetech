...
public class ViagemService extends EntityService<ViagemModel> {
    ...
    public ViagemModel adicionaViagem(ViagemDto viagemDto){
        try {
            Optional<UsuarioModel> usuarioOptional = usuarioRepository.findById(viagemDto.getIdUsuario());
    ...
    public String chatGPT() {
        ...
        String apiKey = "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";
